...
def scan_nobackupdelete_files(source_dir, dir_to_backup, dest_dir=None, tree_depth=3):
    ...
    def scan_recursive(current_dir, base_dir):
        try:
            ...
            for subdir in subdirs:
                scan_recursive(subdir, base_path)
    ...
    scan_recursive(source_dir / dir_to_backup, source_dir / dir_to_backup)
